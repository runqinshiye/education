...
namespace CallMirthWinFromClient
{
    ...
    [ToolboxItem(false)]
    public class WebServiceProxyCallerLib : System.Web.Services.WebService
    {
        ...
        #region 构造函数 
        public WebServiceProxyCallerLib(string wsdlUrl)
        {

            this._wsdlUrl = wsdlUrl;
            string wsdlName = WebServiceProxyCallerLib.getWsclassName(wsdlUrl);
        ...
        public WebServiceProxyCallerLib(string wsdlUrl, string wsdlName)
        {
            this._wsdlUrl = wsdlUrl;
            this._wsdlName = wsdlName;
            this._assName = string.Format(_wsdlNamespace, wsdlName);
        ...
        public object ExecuteQuery(string methodName, string param)
        {
            object rtnObj = null;
            try
            {
